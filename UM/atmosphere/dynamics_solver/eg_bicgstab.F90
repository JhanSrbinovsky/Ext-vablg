...
!print *, "jhan:eg_bic 8s ", s
!print *, "jhan:eg_bic 8t ", t
!print *, "jhan:eg_bic 8pre_type ", pre_type
...
!print *, "jhan:eg_bic 10"
         CALL eg_Calc_Ax(v,p)
!print *, "jhan:eg_bic 11"
...
!$OMP PARALLEL DO PRIVATE(i,j) SHARED(model_levels,rows,row_length,s,r,alf,v)
         ...
         END DO
!$OMP END PARALLEL DO
!print *, "jhan:eg_bic 12"

         CALL eg_precon(cs,s,pre_type)
!print *, "jhan:eg_bic 13"

         CALL eg_calc_Ax(t,cs)
!print *, "jhan:eg_bic 14"
