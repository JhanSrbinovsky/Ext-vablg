...
if(write125) then
   open(unit=125,file='helm125.rhs2',status="unknown", &
...
write(6,'("jhan:hh 1")')
write(6,'("jhan:hh 1:total_conv_inner ",L1)') total_conv_inner
write(6,'("jhan:hh 1:innits",i5.3)') InnIts
      IF( total_conv_inner) InnIts=20

      DO iter = 1, InnIts

if(write125) then
   open(unit=125,file='helm125.rhs3',status="unknown", &
        action="write", form="formatted",position='append' )
      do jhi=jhistart,jhiend; do jhj=jhjstart,jhjend;do jhk=jhkstart,jhkend
         WRITE(125,*) ,rhs(jhi,jhj,jhk)
      enddo; enddo; enddo
...
!write(6,'("jhan:hh 2 "),I5.3') iter
print *,"jhan:hh 1 iter ", iter
...
print *,"jhan:hh 2 iter ", iter
if(write125) then
   open(unit=125,file='helm125.rhs4',status="unknown", &
        action="write", form="formatted",position='append' )
      do jhi=jhistart,jhiend; do jhj=jhjstart,jhjend;do jhk=jhkstart,jhkend
         WRITE(125,*) ,rhs(jhi,jhj,jhk)
      enddo; enddo; enddo
...
print *,"jhan:hh 3 iter ", iter
if(write125) then
   open(unit=125,file='helm125.rhs5',status="unknown", &
        action="write", form="formatted",position='append' )
      do jhi=jhistart,jhiend; do jhj=jhjstart,jhjend;do jhk=jhkstart,jhkend
         WRITE(125,*) ,rhs(jhi,jhj,jhk)
      enddo; enddo; enddo
