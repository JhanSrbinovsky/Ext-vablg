...
if(mype==0 .OR. mype < 20)  print *, "jhan:atmos:pre control2"
   call cable_control2( &
                     npft, &
                     tile_frac, &
                     snow_tile, & 
...
if(mype==0 ) print *, "jhan:atmos_physics2:PRE ni_bl_ctl"
...
if(mype==0 ) print *, "jhan:atmos_physics2:POST ni_bl_ctl"
      IF (l_quick_ap2) THEN
! save outputs for second EG cycle
...
if(mype==0 ) print *, "jhan:atmos_physics2: End "
